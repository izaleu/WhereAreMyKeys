...
namespace WhiteCat
{
	...
	public partial class Tweener : ScriptableComponentWithEditor
	{
		...
		/// 自定义插值方法
		/// </summary>
		public Func<float, float> customInterpolator = null;
		...
		public float normalizedTime
		{
			...
			set
			{
				...
				float factor = customInterpolator == null ?
					_interpolator.Evaluate(_normalizedTime) :
					customInterpolator(_normalizedTime);
