...
namespace WhiteCat
{
	...
	public partial class Path
	{
		...
		protected static GUIContent _globalGUIContent = new GUIContent();
		...
		void OnDrawGizmos()
		{
			if (_editorEnabled || _alwaysVisible)
			{
		...
		protected sealed override void Editor_OnInspectorGUI()
		{
			...
			_rect = EditorGUILayout.GetControlRect(true);
			_rect.xMin += EditorGUIUtility.labelWidth;
			_alwaysVisible = GUI.Toggle(_rect, _alwaysVisible, "Always Visible", EditorStyles.miniButton);
		}
