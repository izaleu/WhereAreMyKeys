...
namespace WhiteCat
{
	...
	public partial class BezierPath
	{
		...
		void DrawSplineUI(Rect rect)
		{
			...
			_globalGUIContent.image = EditorAssets.insertNodeTexture;
			_globalGUIContent.tooltip = "Insert node";

			if (GUI.Button(rect, _globalGUIContent, EditorKit.buttonStyle))
			{
            ...
            _globalGUIContent.image = EditorAssets.prevTexture;
			_globalGUIContent.tooltip = "Previous segment";

			if (GUI.Button(rect, _globalGUIContent, EditorKit.buttonLeftStyle))
			{
			...
			rect.x = rect.xMax;
			_globalGUIContent.image = EditorAssets.nextTexture;
			_globalGUIContent.tooltip = "Next segment";

			if (GUI.Button(rect, _globalGUIContent, EditorKit.buttonRightStyle))
			{
		...
		void DrawForwardControlPointUI(Rect rect)
		{
			...
			rect.Set(_lineRect.xMax + _toolBarHorizontalInterval, rect.y + (rect.height - _toolBarButtonHeight) * 0.5f, _toolBarButtonWidth, _toolBarButtonHeight);
			_globalGUIContent.image = EditorAssets.prevTexture;
			_globalGUIContent.tooltip = "Previous forward control point";
			...
			rect.x = rect.xMax;
			_globalGUIContent.image = EditorAssets.nextTexture;
			_globalGUIContent.tooltip = "Next forward control point";
		...
		void DrawBackControlPointUI(Rect rect)
		{
			...
			rect.Set(_lineRect.xMax + _toolBarHorizontalInterval, rect.y + (rect.height - _toolBarButtonHeight) * 0.5f, _toolBarButtonWidth, _toolBarButtonHeight);
			_globalGUIContent.image = EditorAssets.prevTexture;
			_globalGUIContent.tooltip = "Previous back control point";
			...
			rect.x = rect.xMax;
			_globalGUIContent.image = EditorAssets.nextTexture;
			_globalGUIContent.tooltip = "Next back control point";
		...
		void DrawMiddleControlPointUI(Rect rect)
		{
			...
			rect.Set(_lineRect.xMax + _toolBarHorizontalInterval, rect.y + (rect.height - _toolBarButtonHeight) * 0.5f, _toolBarButtonWidth, _toolBarButtonHeight);
			_globalGUIContent.image = EditorAssets.insertNodeBackTexture;
			_globalGUIContent.tooltip = "Insert Back";
			...
			rect.x = rect.xMax;
			_globalGUIContent.image = EditorAssets.insertNodeForwardTexture;
			_globalGUIContent.tooltip = "Insert Forward";
			...
			rect.x = rect.xMax + _toolBarHorizontalInterval;
			_globalGUIContent.image = EditorAssets.removeNodeTexture;
			_globalGUIContent.tooltip = "Remove node";
			...
			rect.x = rect.xMax + _toolBarHorizontalInterval;
			_globalGUIContent.image = EditorAssets.prevTexture;
			_globalGUIContent.tooltip = "Previous middle control point";
			...
			rect.x = rect.xMax;
			_globalGUIContent.image = EditorAssets.nextTexture;
			_globalGUIContent.tooltip = "Next middle control point";
